...
#                 -  windowsdefault: C:/Program Files/HDF_Group/HDF5/1.10.1
#                 -  linux default:  ./HDF_Group/HDF5/1.10.1
#     CTEST_CONFIGURATION_TYPE  - Release, Debug, etc - default: Release
#     CTEST_SOURCE_NAME  -  source folder [app, mfapp] - default: app
...
set(CTEST_HDF5_VERSION 1.10.1)
set(CTEST_HDF5_VERSEXT "")

##############################################################################
# handle input parameters to script.
#BUILD_GENERATOR - which CMake generator to use, required
#INSTALLDIR - HDF5-1.10.1 root folder
...
if(NOT DEFINED INSTALLDIR)
  if(WIN32)
    set(INSTALLDIR "C:/Program Files/HDF_Group/HDF5/${CTEST_HDF5_VERSION}")
  else()
    set(INSTALLDIR "${CTEST_SCRIPT_DIRECTORY}/HDF_Group/HDF5/${CTEST_HDF5_VERSION}")
  endif()
endif()
