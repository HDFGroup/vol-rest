...
void   *RV_attr_create(void *obj, const H5VL_loc_params_t *loc_params, const char *attr_name,
    hid_t type_id, hid_t space_id, hid_t acpl_id, hid_t aapl_id, hid_t dxpl_id, void **req);
void   *RV_attr_open(void *obj, const H5VL_loc_params_t *loc_params, const char *attr_name,
...
herr_t  RV_attr_get(void *obj, H5VL_attr_get_t get_type, hid_t dxpl_id, void **req, va_list arguments);
herr_t  RV_attr_specific(void *obj, const H5VL_loc_params_t *loc_params, H5VL_attr_specific_t specific_type, hid_t dxpl_id, void **req, va_list arguments);
