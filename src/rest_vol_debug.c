...
object_type_to_string2(H5O_type_t obj_type)
{
    switch (obj_type) {
        ...
        case H5O_TYPE_MAP:            return "H5O_TYPE_MAP";
...
dataset_specific_type_to_string(H5VL_dataset_specific_t specific_type)
{
    switch (specific_type) {
        ...
        case H5VL_DATASET_FLUSH:      return "H5VL_DATASET_FLUSH";
        case H5VL_DATASET_REFRESH:    return "H5VL_DATASET_REFRESH";
        default:                      return "(unknown)";
    } /* end switch */
...
{
    switch (get_type) {
        case H5VL_FILE_GET_CONT_INFO: return "H5VL_FILE_GET_CONT_INFO";
        case H5VL_FILE_GET_FAPL:      return "H5VL_FILE_GET_FAPL";
        case H5VL_FILE_GET_FCPL:      return "H5VL_FILE_GET_FCPL";
        case H5VL_FILE_GET_FILENO:    return "H5VL_FILE_GET_FILENO";
...
object_specific_type_to_string(H5VL_object_specific_t specific_type)
{
    switch (specific_type) {
        ...
        case H5VL_OBJECT_LOOKUP:           return "H5VL_OBJECT_LOOKUP";
        case H5VL_OBJECT_VISIT:            return "H5VL_OBJECT_VISIT";
        case H5VL_OBJECT_FLUSH:            return "H5VL_OBJECT_FLUSH";
        case H5VL_OBJECT_REFRESH:          return "H5VL_OBJECT_REFRESH";
        default:                           return "(unknown)";
    } /* end switch */
