 ...
 * quickly.
 *
 * To create a hash table, use \ref rv_hash_table_new. To destroy a
 * hash table, use \ref rv_hash_table_free.
 *
 * To insert a value into a hash table, use \ref rv_hash_table_insert.
 *
 * To remove a value from a hash table, use \ref rv_hash_table_remove.
 *
 * To look up a value by its key, use \ref rv_hash_table_lookup.
 *
 * To iterate over all values in a hash table, use
 * \ref rv_hash_table_iterate to initialize a \ref rv_hash_table_iter
...
typedef struct rv_hash_table rv_hash_table_t;

/**
 * Structure used to iterate over a hash table.
 */

typedef struct rv_hash_table_iter rv_hash_table_iter_t;

/**
 * Internal structure representing an entry in a hash table.
 */

typedef struct rv_hash_table_entry rv_hash_table_entry_t;

/**
 * A key to look up a value in a \ref rv_hash_table_t.
 */

typedef void *rv_hash_table_key_t;

/**
 * A value stored in a \ref rv_hash_table_t.
 */

typedef void *rv_hash_table_value_t;

/**
 * Definition of a \ref rv_hash_table_iter.
 */
...
typedef unsigned int (*rv_hash_table_hash_func_t)(rv_hash_table_key_t value);
...
typedef void (*rv_hash_table_value_free_func_t)(rv_hash_table_value_t value);
