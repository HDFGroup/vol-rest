...
static int hash_table_allocate_table(rv_hash_table_t *hash_table)
{
	...
	hash_table->table = (rv_hash_table_entry_t **) calloc(hash_table->table_size,
	                           sizeof(rv_hash_table_entry_t *));
...
static void hash_table_free_entry(rv_hash_table_t *hash_table, rv_hash_table_entry_t *entry)
{
...
static int hash_table_enlarge(rv_hash_table_t *hash_table)
{
...
void rv_hash_table_iterate(rv_hash_table_t *hash_table, rv_hash_table_iter_t *iterator)
{
	unsigned int chain;
